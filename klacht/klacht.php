...
class klacht
{
    ...
    function __construct($naam = NULL, $email = NULL, $datum = NULL, $klachtOmschrijving = NULL, $extraDetail = null, $image = NULL,
                         $longitude = NULL, $latitude = NULL, $wijken_Id = NULL, $status_Id = null, $opmerking = null)
    {
    ...
    public function create()
    {
        ...
        try {
            global $conn;
            $sql = $conn->prepare("INSERT INTO klacht VALUES (:Id,:naam, :email,:datum, :klachtOmschrijving, :extraDetail, :image, :longitude, :latitude, :wijken_Id, :status_Id, :opmerking)");
            $sql->bindParam(":Id", $Id);
